...
function ProfileHandler(db) {
    ...
    this.handleProfileUpdate = (req, res, next) => {
        ...
        // Reject oversized input before regex evaluation (defence-in-depth against ReDoS)
        if (bankRouting && bankRouting.length > 50) {
            return res.render("profile", {
                updateError: "Bank Routing number is too long",
                firstNameSafeString: firstName,
                lastName, ssn, dob, address, bankAcc, bankRouting
            });
        }
